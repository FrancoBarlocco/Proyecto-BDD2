...
export class MatchesService {
  ...
  getMatches(): Promise<Match[]> {
    return new Promise((resolve, reject) => {
      const matches: Match[] = [
        new Match(0, 'Estadio Centenario', '2024-06-14', 1, 2, '/assets/images/png-transparent-flag-of-uruguay-national-flag-flags-of-the-world-flag-miscellaneous-flag-text.png', '/assets/images/png-transparent-flag-of-uruguay-national-flag-flags-of-the-world-flag-miscellaneous-flag-text.png'),
